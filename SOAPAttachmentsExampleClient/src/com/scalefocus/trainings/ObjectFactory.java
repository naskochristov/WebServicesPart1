 ...
 * generated in the com.scalefocus.trainings package. 
...
public class ObjectFactory {
    ...
    private final static QName _UploadFile_QNAME = new QName("http://trainings.scalefocus.com", "uploadFile");
    private final static QName _UploadFileResponse_QNAME = new QName("http://trainings.scalefocus.com", "uploadFileResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.scalefocus.trainings
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://trainings.scalefocus.com", name = "uploadFile")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://trainings.scalefocus.com", name = "uploadFileResponse")
